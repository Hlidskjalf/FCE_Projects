 ...
 * files in use.
 *  Version - 0.0.3 - Checks for the .$$$ files on the C:\ drive
 ...
 * C:\Program Files\Pinnacle\Oaswin.
 */
...
void datadict_fix_C()
{
  if(remove("C:\\Program Files\\Pinnacle\\Oaswin\\DATADICT.$$$")== 0){
    ...
    system("del /F /Q /Y \"C:\\Program Files\\Pinnacle\\Oaswin\\DATADICT.DBF\"");
    system("del /F /Q /Y \"C:\\Program Files\\Pinnacle\\Oaswin\\DATADICT.CDX\"");
    system("del /F /Q /Y \"C:\\Program Files\\Pinnacle\\Oaswin\\DATADICT.FPT\"");

    // Then copy the files from C:\Install\DATADICT_REPO
    CopyFile("C:\\Install\\DATADICT_REPO\\DATADICT.DBF",
	      "C:\\Program Files\\Pinnacle\\Oaswin\\DATADICT.DBF", TRUE);
    CopyFile("C:\\Install\\DATADICT_REPO\\DATADICT.CDX",
	      "C:\\Program Files\\Pinnacle\\Oaswin\\DATADICT.CDX", TRUE);
    CopyFile("C:\\Install\\DATADICT_REPO\\DATADICT.FPT",
	      "C:\\Program Files\\Pinnacle\\Oaswin\\DATADICT.FPT", TRUE); 
  } else {
    return;
  }
}
...
void datadict_fix_E()
{
  if(remove("E:\\Pinnacle\\Oaswin\\PL\\DATADICT.$$$")== 0){
    ...
    // If the DATADICT.$$$ file existed on E:\Pinnacle\Oaswin, delete the block
    system("del /F /Q /Y E:\\Pinnacle\\Oaswin\\PL\\DATADICT.DBF");
    system("del /F /Q /Y E:\\Pinnacle\\Oaswin\\PL\\DATADICT.CDX");
    system("del /F /Q /Y E:\\Pinnacle\\Oaswin\\PL\\DATADICT.FPT");

    // Then copy the files from C:\Install\DATADICT_REPO
    CopyFile("C:\\Install\\DATADICT_REPO\\DATADICT.DBF",
	      "E:\\Pinnacle\\Oaswin\\PL\\DATADICT.DBF", TRUE);
    CopyFile("C:\\Install\\DATADICT_REPO\\DATADICT.CDX",
	      "E:\\Pinnacle\\Oaswin\\PL\\DATADICT.CDX", TRUE);
    CopyFile("C:\\Install\\DATADICT_REPO\\DATADICT.FPT",
	      "E:\\Pinnacle\\Oaswin\\PL\\DATADICT.FPT", TRUE); 
  } else {
    return;
  }
}
